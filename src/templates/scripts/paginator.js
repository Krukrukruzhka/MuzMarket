...
function PaginationButton(totalPages, maxPagesVisible = 10, currentPage = 1) {
    let pages = pageNumbers(totalPages, maxPagesVisible, currentPage); // массив первых maxPagesVisible страниц
    ...
    this.render = (container = document.getElementsByClassName('product')[0]) => {
...
const paginationButtons = new PaginationButton(5, 3);
